                                                            ...
                                                            <div class="p-4">
                                                                    ...
                                                                    <div class="border-top mt-4 pt-4">
                                                                        <div class="d-flex justify-content-between">
                                                                            ...
                                                                            <h6 class="m-0"> <a href="package.php#package-view-silver">View More</a></h6>
                                                                        </div>
                                                                        </div>
                                                            </div>
                                                                ...
                                                                <div class="p-4">
                                                                    ...
                                                                    <div class="border-top mt-4 pt-4">
                                                                        <div class="d-flex justify-content-between">
                                                                            ...
                                                                            <h6 class="m-0"> <a href="package.php#package-view-gold" >View More</a></h6>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        </div>
                                                                ...
                                                                <div class="d-flex justify-content-between mb-3">
                                                                    ...
                                                                    <div class="border-top mt-4 pt-4">
                                                                        ...
                                                                        <h6 class="m-0">₹<?php echo $to_plat['package_amont']; ?> per person<br><h6 class="m-0 text-primary mr-2" id="first_amount-plat-fixed"></46> </h6>
                                                                            <h6 class="m-0"> <a href="package.php#package-view-plat">View More</a></h6>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
...
<!--Silver Packages Start -->
            <div class="container-fluid py-5" id="package-view-silver">
                <div class="container pt-5 pb-3">
                    <div class="text-center mb-3 pb-3">
                        <h6 class="text-primary text-uppercase" style="letter-spacing: 5px;">Silver Packages</h6>
                        <h1>Your Silver Packages</h1>
                    ...
                    <?php 
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="destination-item position-relative overflow-hidden mb-2">
                                <img class="img-fluid" src="img/silver1.jpg" alt="">
                        ...
                        <h1>Stay</h1>
                            <div class="package-item bg-white mb-2">
                                ...
                                <div class="p-4">
                                    ...
                                    <a class="h5 text-decoration-none" href="">Hotel-<small><?php echo $allot_place_package_urow['hotel_name']; ?> {<?php echo $allot_place_package_urow['venue']; ?>}</small></a>  
...
?>
                        ...
                        <h1>Guide</h1>
                            <div class="package-item bg-white mb-2">
                                <img class="img-fluid" src="img/guide1.jpg" alt="">
                                <div class="p-4">
                                    <div class="d-flex justify-content-between mb-3">
...
$result1=mysqli_query($conect,$insert1)or die("query failed");
while($to_gold = mysqli_fetch_assoc($result1)){
    $allot_gold_card_get=$to_gold['id'];
?>
<!--Gold Packages Start -->

            <div class="container-fluid py-5" id="package-view-gold">
                <div class="container pt-5 pb-3">
                    <div class="text-center mb-3 pb-3">
                        <h6 class="text-primary text-uppercase" style="letter-spacing: 5px;">Gold Packages</h6>
                        <h1>Your Gold Packages</h1>
                        <h5><?php echo $to_gold['no_of_days']; ?><h5>
                    </div>
                    <h4 class="text-primary text-uppercase" style="letter-spacing: 5px;">Your Visiting Places</h4>
                    <div class="row">
                    <?php 
                        $allot_gold_place_package_quary="SELECT * FROM package_places where gold='$allot_gold_card_get'";
                        $allotgold__package_view = mysqli_query($conect,$allot_gold_place_package_quary);
                        while($allotgold__package_urow = mysqli_fetch_array($allotgold__package_view)){
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="destination-item position-relative overflow-hidden mb-2">
                                <img class="img-fluid" src="img/silver1.jpg" alt="">
                                <a class="destination-overlay text-white text-decoration-none" href="single.php">
                                    <h5 class="text-white"><?php echo $allotgold__package_urow['Place']; ?></h5>
                                    <span>Dhoonaan Dhar Waterfall</span>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="destination-item position-relative overflow-hidden mb-2">
                                <img class="img-fluid" src="img/silver2.jpg" alt="">
                                <a class="destination-overlay text-white text-decoration-none" href="">
                
                                <h5 class="text-white">Gori Ghat</h5>
                                    <span>Narmada Devi</span>
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="destination-item position-relative overflow-hidden mb-2">
                                <img class="img-fluid" src="img/silver3.jpg" alt="">
                                <a class="destination-overlay text-white text-decoration-none" href="">
                                    <h5 class="text-white">Madan Mahal</h5>
                                    <span>Rani Durgavati Kila</span>
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="destination-item position-relative overflow-hidden mb-2">
                                <img class="img-fluid" src="img/tilwara_ghat.jpg" alt="">
                                <a class="destination-overlay text-white text-decoration-none" href="">
                                    <h5 class="text-white">Tilwara Ghat</h5>
                                    <span>Near Gori Ghat</span>
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="destination-item position-relative overflow-hidden mb-2">
                                <img class="img-fluid" src="img/sangram_sagar.jpg" alt="">
                                <a class="destination-overlay text-white text-decoration-none" href="">
                                    <h5 class="text-white">Sangram Sagar</h5>
                                    <span>Lake</span>
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="destination-item position-relative overflow-hidden mb-2">
                                <img class="img-fluid" src="img/ghoonghara_waterfall.jpg" alt="">
                                <a class="destination-overlay text-white text-decoration-none" href="">
                                    <h5 class="text-white">Ghoonghara</h5>
                                    <span>Waterfall</span>
                                </a>
                            </div>
                        </div>
            ...
            <h4 class="text-primary text-uppercase" style="letter-spacing: 5px;">Your facilities</h4>
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="package-item bg-white mb-2">
                                <img class="img-fluid" src="img/g_room.jpg" alt="">
                                <div class="p-4">
                                    <div class="d-flex justify-content-between mb-3">
                                        <small class="m-0"><i class="fa fa-calendar-alt text-primary mr-2"></i><a class="m-0" id="room_day"></a></small>
                                    </div>
                                    <a class="h5 text-decoration-none" href="">Stay-<small>Non Ac Room with free wifi 24 * 7 and 52 inch tv in room</small></a>  
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="package-item bg-white mb-2">
                                <img class="img-fluid" src="img/guide-5.jpg" alt="">
                                <div class="p-4">
                                    <div class="d-flex justify-content-between mb-3">
                                    <small class="m-0"><i class="fa fa-user text-primary mr-2"></i><a id="pack_person"></a>Person</small>
                                    </div>
                                    <a class="h5 text-decoration-none" href="">Guide- <small>Help You to visit your favourite Place</small></a>
                                    </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="package-item bg-white mb-2">
                                <img class="img-fluid" src="img/car-12.jpg" alt="">
                                <div class="p-4">
                                    <div class="d-flex justify-content-between mb-3">
                                        <small class="m-0"><i class="fa fa-map-marker-alt text-primary mr-2"></i><a id="pack_city"></a></small>
                                    </div>
                                    <a class="h5 text-decoration-none" href="">Travel-<small>Pic and drop facility according to you</small></a>
                    ...
                    <div class="border-top mt-4 pt-4">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <h4 class="m-0  mr-2"> ₹<?php echo $to_gold['package_amont'];?> Per Person <br><a class="m-0 text-primary mr-2" id="total_gold"></a></h4>
                                            <?php
                                            
                                                ?>
                                            <div class="col-md-2">
                            <a href="package.php?card_id=<?php echo $to_gold['id'];?>"> 
                            <button class="btn btn-primary btn-block pricingTable-signup" style="height: 47px; margin-top: -2px;">Book Package</button>
                        </a>
                            </div>
                            <?php
                            }
...
$result2=mysqli_query($conect,$insert2)or die("query failed");
while($to_plat = mysqli_fetch_assoc($result2)){
    $allot_card_get=$to_plat['id'];
?>

<!--Platinum Packages Start -->

            <div class="container-fluid py-5" id="package-view-plat">
                <div class="container pt-5 pb-3">
                    <div class="text-center mb-3 pb-3">
                        <h6 class="text-primary text-uppercase" style="letter-spacing: 5px;">Platinum Packages</h6>
                        <h1>Your Platinum Packages</h1>
                        <h5><?php echo $to_plat['no_of_days']; ?><h5>
                    </div>
                    <h4 class="text-primary text-uppercase" style="letter-spacing: 5px;">Your Visiting Places</h4>
                    <div class="row">
                    <?php 
                        $allot_plat_place_package_quary="SELECT * FROM package_places where Platinum='$allot_card_get'";
                        $allotplat__package_view = mysqli_query($conect,$allot_plat_place_package_quary);
                        while($allotplat__package_urow = mysqli_fetch_array($allotplat__package_view)){
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="destination-item position-relative overflow-hidden mb-2">
                                <img class="img-fluid" src="img/silver1.jpg" alt="">
                                <a class="destination-overlay text-white text-decoration-none" href="single.php">
                                    <h5 class="text-white"><?php echo $allotplat__package_urow['Place']; ?></h5>
                                    <span>Dhoonaan Dhar Waterfall</span>
                                </a>
                            </div>
                        </div>
            ...
            <h4 class="text-primary text-uppercase" style="letter-spacing: 5px;">Your facilities</h4>
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="package-item bg-white mb-2">
                                <img class="img-fluid" src="img/p_room.jpg" alt="">
                                <div class="p-4">
                                    <div class="d-flex justify-content-between mb-3">
                                        <small class="m-0"><i class="fa fa-calendar-alt text-primary mr-2"></i><a class="m-0" id="room_day"></a></small>
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="package-item bg-white mb-2">
                                <img class="img-fluid" src="img/guide_3.webp" alt="">
                                <div class="p-4">
                                    <div class="d-flex justify-content-between mb-3">
                                    <small class="m-0"><i class="fa fa-user text-primary mr-2"></i><a id="pack_person"></a>Person</small>
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="package-item bg-white mb-2">
                                <img class="img-fluid" src="img/car-8.webp" alt="">
                                <div class="p-4">
                                    <div class="d-flex justify-content-between mb-3">
                                        <small class="m-0"><i class="fa fa-map-marker-alt text-primary mr-2"></i><a id="pack_city"></a></small>
                                    </div>
                    ...
                    <div class="border-top mt-4 pt-4">
                                        ...
                                        <div class="d-flex justify-content-between">
                                        <h4 class="m-0  mr-2"> ₹<?php echo $to_plat['package_amont'];?> Per Person<br><a class="m-0 text-primary mr-2" id="total_plat"></a></h4>
                                            ...
                                            <?php
                                                ...
                                                ?>
                            <a href="package.php?card_id=<?php echo $to_plat['id'];?>"> <button class="btn btn-primary btn-block pricingTable-signup" style="height: 47px; margin-top: -2px;">Book Package</button></a>
                            </div>
                            <?php
                                            }
                            ?>
