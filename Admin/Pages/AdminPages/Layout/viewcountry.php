...
$quary="select * from countries where status='Avail'";
  ...
  <table class="table" id="countytable">
    ...
    <tbody>
      ...
      <?php while($row=mysqli_fetch_array($result)){?>
                      ...
                      <td><a data-id="<?php echo $row['id']?>" class="editcountry" ><i class="fas fa-edit"></a></i></td>
                      <td><a data-id="<?php echo $row['id']?>" class="removecountry"><i class="fa fa-trash" aria-hidden="true"></a></i></td>
                    </tr>
                    <?php } ?>
      </tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Edit Country Data</h4>
    ...
    ?>
      ...
      <form Action="../../Action/CountryAction.php" method="POST" class="form-group" enctype="multipart/form-data"> 
                    ...
                    <div class="col-md-6"><input type="text" class="form-control" id="name"  name="countryname"></div> 
                    </div>
                    <div class="row mt-3">
                    <div class="col-md-6"><label class="form-control" value="Gmail" placeholder="Gmail">Gmail</label></div>   
                    <div class="col-md-6"><input type="text" class="form-control" id="shortname" name="shortname" ></div>
                        
                    </div>
                    <div class="row mt-3">
                    <div class="col-md-6"><label class="form-control" value="Contact" placeholder="Contact">Contact</label></div>   
                    <div class="col-md-6"><input type="text" class="form-control" id="phonecode"  name="phonecode" ></div>
                        
                    </div>
                 
                  <div class="mt-5 text-right"><button class="btn btn-primary profile-button" type="submit" name="updatedata">Edit Changes</button>   <button type="button" class="btn btn-default" data-dismiss="modal" >Close</button></div>
    ...
    <div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="../../Action/CountryAction.php" method="POST">
