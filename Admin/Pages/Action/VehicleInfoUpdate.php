...
while($row=mysqli_fetch_array($resultvd)){
    ...
    <form role='form'>
    <div class='card-body'>
    <input type='hidden' hidden class='form-control' id='v_id' placeholder='' name='id' value='{$row["t_id"]}'>
    ...
    <div class='form-group'>
      ...
      <input type='text' class='form-control' id='contact_number' placeholder='' value='{$row["contact_number"]}'>
    </div>
    <div class='form-group'>
...
<div>
<input type='submit' id='Vehicle-update-submit' value='Update' class='btn btn-block btn-outline-warning  btn-lg'>
